...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~357c8ec4581c7bc7d7c387e5f1e52012:467255685241744a454f4d3d',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "ROCKY",
    BOT_NAME: process.env.BOT_NAME || 'Rocky',
